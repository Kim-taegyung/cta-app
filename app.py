...
def manage_templates_modal():
    st.caption("자주 사용하는 루틴을 세트로 만들어두세요. (예: 평일 루틴, 주말 루틴)")
    ...
    if templates:
        # 보기 좋게 DataFrame으로 변환해서 보여주거나, 리스트로 나열
